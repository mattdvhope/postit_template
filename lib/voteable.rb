...
# Lines 3-25 are commented out and also extracted to a gem at: https://rubygems.org/gems/voteable_matt38
# module Voteable # This code is extracted from post.rb & comment.rb models.
#   extend ActiveSupport::Concern #this (Concern) is something new for Rails 4; this abstracts away a common pattern for meta-programming; it means that all the instance methods written here are going to be instance methods when I include/mix-in this Module.
...
#   def total_votes #business-logic performed here in the model (for '_post.html.erb' & '_comment.html.erb')
