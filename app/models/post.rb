...
# has_many :votes, as: :voteable ..has been extracted to lib/voteable.rb
  ...
  before_save :generate_slug #We're using the 'after_validation' (ActiveRecord Callback) method to generate the slug after validation, but before .save ; This implies that our 'generate_slug' method will be executed even for updates; 'after_validation' callback method could also work
